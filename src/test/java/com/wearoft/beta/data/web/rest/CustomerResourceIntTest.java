package com.wearoft.beta.data.web.rest;

import com.wearoft.beta.data.BetaDataApp;

import com.wearoft.beta.data.domain.Customer;
import com.wearoft.beta.data.repository.CustomerRepository;
import com.wearoft.beta.data.service.CustomerService;
import com.wearoft.beta.data.web.rest.errors.ExceptionTranslator;
...
import static com.wearoft.beta.data.web.rest.TestUtil.createFormattingConversionService;
...
@SpringBootTest(classes = BetaDataApp.class)
public class CustomerResourceIntTest {
    ...
    public void createCustomer() throws Exception {
        ...
        assertThat(testCustomer.getAccountAddress()).isEqualTo(DEFAULT_ACCOUNT_ADDRESS);
    }
    ...
    public void updateCustomer() throws Exception {
        ...
        assertThat(testCustomer.getAccountAddress()).isEqualTo(UPDATED_ACCOUNT_ADDRESS);
    }
