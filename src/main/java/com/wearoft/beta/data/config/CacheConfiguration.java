package com.wearoft.beta.data.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("betaData");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("betaData");
        ...
        config.getMapConfigs().put("com.wearoft.beta.data.domain.*", initializeDomainMapConfig(jHipsterProperties));
